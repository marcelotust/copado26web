...
const SECTIONS = {
  privacy: ['legal.privacy.intro', 'legal.privacy.data', 'legal.privacy.rights'],
  terms: ['legal.terms.intro', 'legal.terms.use', 'legal.terms.liability'],
} as const

type LegalPageProps = { kind: keyof typeof SECTIONS }
