...
export default function LandingHeroPreviewBadge({ config }: Props) {
  ...
  return (
    <div
      className='fixed bottom-3 left-3 right-3 sm:right-auto z-[100] max-w-md rounded-xl border border-amber-500/40 bg-slate-900/95 px-3 py-2 text-[11px] text-amber-100/90 shadow-lg backdrop-blur-sm font-mono leading-relaxed'
      role='status'
    >
