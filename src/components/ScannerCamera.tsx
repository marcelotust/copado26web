...
export default function ScannerCamera({ ready, scanning, rawText, autoScan, onCapture }: ScannerCameraProps) {
  const { t } = useI18n();
      ...
      {camError ? (
        ...
        <div className='relative w-full max-w-lg rounded-2xl overflow-hidden bg-slate-900 shadow-2xl'>
          <Webcam
            ...
            onUserMediaError={(e) => setCamError(typeof e === 'string' ? e : (e?.message ?? String(e)))}
