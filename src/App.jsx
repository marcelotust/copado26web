...
/** @param {{ session: import('@supabase/supabase-js').Session, signOut: () => Promise<void> }} props */
function AuthenticatedApp({ session, signOut }) {
  const { t } = useI18n()
...
function CatalogErrorScreen({ error }) {
  const { t } = useI18n()
