...
description: Use proactively for React, TypeScript, i18n, state, and responsive UI work.
---

Implement React/TypeScript UI changes in the existing product style.

Use when a change touches pages, components, hooks, state, i18n, or responsive behavior.
